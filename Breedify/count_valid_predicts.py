...
model = load_model(r'C:\Users\denys\Desktop\UI\telegram bot\best_model_unfreeze30_test.h5', custom_objects=custom_objects)


# Path to the folder containing subfolders of dog breeds (test dataset)
test_folder = r'C:\Users\denys\Desktop\UI\test_images'
